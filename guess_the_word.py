...
while user_guess != secret_word:        # loop will run until this statement is true
    ...
    elif 2 <= count < 4:     # After the 1st guess, the user is alerted about the wrong answer. only 5 guesses are
        print("Nope! try again!")       # allowed in total (count = (0-4)) and this statement is printed 2 times
    ...
    elif count > 3:                     # after the 5th guess, if the answer is still wrong, the game ends.
